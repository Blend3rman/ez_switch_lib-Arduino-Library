...
#define hour_adjust_switch     10  // a physical button switch, masquerading as a toggle switch
#define min_adjust_switch      11  // physical button switch, masquerading as a toggle switch
